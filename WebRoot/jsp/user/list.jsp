...
<body>
	<form id="userForm" name="userForm" action="${pageContext.request.contextPath }/customerServlet?method=list"
		method=post>
											...
											<tbody>
												...
												<tr
											 	...
											 	<!--  	<a href="${pageContext.request.contextPath }/customerServlet?method=edit&custId=${user.user_id}">修改</a>  -->
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/user_delete.action?userid=${user.user_id}">删除</a>
